    ...
    return (
        <div
            ...
            <div className="flex flex-col gap-6 mt-12">
                <p className="text-6xl text-[#2D554D] text-center font-semibold">Answer</p>
                <p className="text-2xl text-center text-[#2D554A]">{word.definition}</p>
            </div>


            <p className="text-2xl mt-8">Did you know the answer?</p>

            <div className="flex gap-4 mt-6">
                <button
                    onClick={()=>{review_word(true)}}
                    className="w-fit text-2xl  px-10 py-2 border border-green-600 rounded-xl bg-green-600 text-white hover:cursor-pointer ">
                    Yes
                </button>
                <button
                    onClick={()=>review_word(false)}
                    className="w-fit text-2xl  px-10 py-2 border border-red-600 rounded-xl bg-red-600 text-white hover:cursor-pointer "
                >
                    No
                </button>
            </div>
